        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="{{url('dokter/pemeriksaan')}}" > <i class="menu-icon fa fa-laptop"></i>Pemeriksaan</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="" > <i class="menu-icon fa fa-th"></i>Resep</a>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Obat</a>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="/dokter/pemeriksaan">Login</a></li>
