...
<div class="content mt-3">
    ...
    @if (auth()->user()->peran->peran=='Administrator')
        <a class="btn btn-primary" href="{{ route('pasien.edit',$pengguna) }}" role="button">Ubah</a>
        <form class="d-inline-block" action="{{ route('pasien.destroy',$pengguna) }}" method="post">
            @csrf @method('delete')
        ...
        <div class="modal fade" id="modalPeriksa" tabindex="-1" role="dialog" aria-labelledby="titleModalPeriksa" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="formDataPeriksa" action="{{ route('periksa.store',$pengguna) }}" method="POST">
                        @csrf
